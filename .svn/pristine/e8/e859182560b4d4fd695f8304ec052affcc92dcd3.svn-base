...
// serverUrl = "http://192.168.1.30:10000";
// serverUrl = "http://101.200.0.99:10000";
serverUrl = "http://192.168.1.3:10006";
serverUrl = "http://118.190.90.2:10010";
//serverUrl = "http://120.76.217.108:10006";
...
var classifyUrl = serverUrl + "/category/all";
//========登录的url开始======
...
var updateUserUrl = serverUrl + "/user/update";//更新用户信息
var certificationUrl = serverUrl + "/user/certification";//认证信息
var followUrl = serverUrl + "/user/follow";//关注
var followPagerUrl = serverUrl + "/event/followPager";//我参与帮助过的列表
var getMyWalletPagerUrl = serverUrl + "/user/getMyWalletPager";//钱包列表
//==================系统相关=================
var initSystemInfoUrl = serverUrl + "/system/carousels";//获取首页轮播图 
var pageByOrderUrl = serverUrl + "/event/pageByOrder";//首页列表
//=============================事件相关======================================
var pageByLocationUrl = serverUrl + "/event/pageByLocation";//附近的消息列表
var pageByCidUrl = serverUrl + "/event/pageByCid";//按照分类查看 ok
var pageByUserUrl = serverUrl + "/event/pageByUser";//获取我发布的或者获取我捡到的列表 ok
var pageBySearchUrl = serverUrl + "/event/pageBySearch";//搜索
var hotKeywordUrl = serverUrl + "/event/hotKeyword";//热词 ok
var eventInfoUrl = serverUrl + "/event/eventInfo";//信息详情
var publishUrl = serverUrl + "/event/publish";//发布信息 ok
var helpUrl = serverUrl + "/event/help";//参与帮助
var eventCreateAuthCodeUrl = serverUrl + "/event/createAuthCode";//获取失主联系方式的验证码,或者是支付验证码
var getPhoneUrl = serverUrl + "/event/getPhone";//获取失主手机号信息
var selectHelperUrl = serverUrl + "/event/selectHelper";//选择帮助人
var confirmSuccessUrl = serverUrl + "/event/confirmSuccess";//确认帮助人0
var agreeFailUrl = serverUrl + "/event/agreeFail";//同意帮助失败
var disagreeFailUrl = serverUrl + "/event/disagreeFail";//帮助人不申诉
var confirmFailUrl = serverUrl + "/event/confirmFail";//失主不同意打款
var eventMeUrl = serverUrl + "/event/me";//失主选择的是我
var selectUserUrl = serverUrl + "/event/selectUser";//确认失主
var rechargeWalletUrl = serverUrl + "/user/rechargeWallet";//充值
var orderPayParamUrl = serverUrl + "/pay/alipay/orderPayParam";//获取支付参数
var createTransItemUrl = serverUrl + "/pay/alipay/createTransItem";//支付宝提现
var getMessagePageUrl = serverUrl + "/user/getMessagePage";//获取消息
var payEventOrderUrl = serverUrl + "/event/payEventOrder";//支付订单
var createRefundOrderUrl = serverUrl + "/pay/alipay/createRefundOrder";//退款
var getCertificationUrl= serverUrl + "/user/getCertification";//获取用户认证信息
//========================评论====================================

var commentPublishUrl = serverUrl +"/comment/publish";
var commentPageUrl = serverUrl +"/comment/page";


//========================聊天=========================================
//=========IM通知的url开始==============
var message_connectUrl=serverUrl+"/chat/connect";
var message_pagerUrl=serverUrl+"/chat/pager";
var message_checkChatUrl=serverUrl+"/chat/checkChat";
var message_chatUrl=serverUrl+"/chat/chat";
var message_testUrl=serverUrl+"/chat/test";
var message_deleteUrl=serverUrl+"/chat/delete";
//=========IM通知url结束==============
...
function openChat(type,thirdId,thirdNick){
	openNewWindow("chat","./chat.html",{type:type,thirdId:thirdId,thirdNick:thirdNick});
}
