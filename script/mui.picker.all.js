...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-poppicker-bottom-button">\
			<button data-id="btn-cancel" class="mui-poppicker-bottom-left mui-poppicker-btn-cancel">取消</button>\
			<button data-id="btn-ok" class="mui-poppicker-bottom-right mui-poppicker-btn-ok">确定</button>\
		</div>\
		\
		<div class="mui-dtpicker-title"><h5 data-id="title-y" id="year-style">年</h5><h5 data-id="title-m" class="other-style">月</h5><h5 data-id="title-d" class="other-style">日</h5><h5 data-id="title-h" class="other-style">时</h5><h5 data-id="title-i">分</h5></div>\
		<div class="mui-dtpicker-body">\
			<div data-id="picker-y" class="mui-picker year-style">\
				<div class="mui-picker-inner">\
					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
					<ul class="mui-pciker-list">\
					</ul>\
			...
			<div data-id="picker-m" class="mui-picker other-style">\
				<div class="mui-picker-inner">\
					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
					<ul class="mui-pciker-list">\
					</ul>\
			...
			<div data-id="picker-d" class="mui-picker other-style">\
				<div class="mui-picker-inner">\
					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
					<ul class="mui-pciker-list">\
					</ul>\
			...
			<div data-id="picker-h" class="mui-picker other-style">\
				<div class="mui-picker-inner">\
					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>\
					<ul class="mui-pciker-list">\
					</ul>\
